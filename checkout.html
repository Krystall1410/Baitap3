        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="checkout.html">Thông tin thanh toán</a></li>
                </ul>
            </nav>
                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control mb-3" id="street_address" placeholder="Quận/Huyện" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="city" placeholder="Chi tiết địa chỉ" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="zipCode" placeholder="Mã ZIP" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="number" class="form-control" id="phone_number" min="0" placeholder="SĐT liên hệ" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                            ...
                                            <label class="custom-control-label" for="customCheck2">Tạo tài khoản mới</label>
                                        </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                <li><span>Số tiền tạm tính:</span> <span>32.969.000VND</span></li>
                                <li><span>Phí giao hàng:</span> <span>Miễn phí</span></li>
                                <li><span>Tổng tiền:</span> <span>32.969.000VND</span></li>
                            </ul>
